...
public class LikeService {
    ...
    //like opinion
    public Like likeOpinion(User user, String opinionID) throws IllegalAccessException, NoSuchElementException {
        Opinion opinion = opinionRepository.findById(UUID.fromString(opinionID)).orElseThrow(() -> new NoSuchElementException("Opinion not found."));
    ...
    public void deleteLike(User user, String likeID) throws IllegalAccessException, NoSuchElementException {
        Like like = likeRepository.findById(UUID.fromString(likeID)).orElseThrow(() -> new NoSuchElementException("Like not found"));
